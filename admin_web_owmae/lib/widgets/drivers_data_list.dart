...
{
  final driversRecordsFromDatabase = FirebaseDatabase.instance.ref().child("motoristas");
          ...
          itemBuilder: ((context, index)
          {
            return Row(
              ...
              children: [
                ...
                cMethods.data(
                  1,
                  Text(itemsList[index]["nome"].toString()),
                ),

                cMethods.data(
                  1,
                  Text(
                      itemsList[index]["carro_detalhes"]["carroModelo"].toString() + " - " +
                          itemsList[index]["carro_detalhes"]["carroPlaca"].toString()
                  ),
                ),

                cMethods.data(
                  1,
                  Text(itemsList[index]["telefone"].toString()),
                ),

                cMethods.data(
                  1,
                  itemsList[index]["ganhos"] != null ?
                  Text("\$ " + itemsList[index]["ganhos"].toString())
                      : const Text("\$ 0"),
                ),
